...
import com.example.assignment.databinding.ActivityMain136Binding

class MainActivity136 : AppCompatActivity() {

    private lateinit var binding: ActivityMain136Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMain136Binding.inflate(layoutInflater)
