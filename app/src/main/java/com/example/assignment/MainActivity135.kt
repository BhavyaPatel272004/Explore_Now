...
import com.example.assignment.databinding.ActivityMain135Binding

class MainActivity135 : AppCompatActivity() {

    private lateinit var binding: ActivityMain135Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMain135Binding.inflate(layoutInflater)
