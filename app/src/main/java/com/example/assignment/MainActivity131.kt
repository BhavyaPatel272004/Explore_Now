...
import com.example.assignment.databinding.ActivityMain131Binding

class MainActivity131 : AppCompatActivity() {

    private lateinit var binding: ActivityMain131Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMain131Binding.inflate(layoutInflater)
