...
import com.example.assignment.databinding.ActivityMain133Binding

class MainActivity133 : AppCompatActivity() {

    private lateinit var binding: ActivityMain133Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMain133Binding.inflate(layoutInflater)
