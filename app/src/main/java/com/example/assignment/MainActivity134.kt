...
import com.example.assignment.databinding.ActivityMain134Binding

class MainActivity134 : AppCompatActivity() {

    private lateinit var binding: ActivityMain134Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMain134Binding.inflate(layoutInflater)
